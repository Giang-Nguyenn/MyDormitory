...
class Admin_Messenger_Adapter extends BaseAdapter {
    Hi hi=new Hi();
    private Context context;
    private int layout;
    private String Image;
    private List<Admin_Messenger> messengerList;

    public Admin_Messenger_Adapter(Context context, int layout, String image, List<Admin_Messenger> messengerList) {
