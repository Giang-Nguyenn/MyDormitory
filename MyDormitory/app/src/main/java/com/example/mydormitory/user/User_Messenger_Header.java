...
class User_Messenger_Header {
    ...
    public User_Messenger_Header() {
    }

    public User_Messenger_Header(String id_mess, String id_send, String messenger, String status, String time, String image, String name, String activiti) {
        Id_mess = id_mess;
        Id_send = id_send;
